...
public class ShiftTracker {
	/**
	 * Map of all Shifts in all PayPeriods in the model, where the key is a string of the Shift date,
	...
	/**
	 * Create a new CGShift with the given arguments and add it to the Map of created Shifts.
	 *
	...
	/**
	 * Create a new MarketShift with the given arguments and add it to the Map of created Shifts.
	 *
