...
public class TestShift {
	...
	public static Shift[] createShiftsArr() {
		...
		String[] fri1 = new String[] { "F", "03/18/2022", "7:52 AM", "10:00 AM", "3", "14" };
		MarketShift tm_fri1 = new MarketShift(fri1);
		String[] sat1 = new String[] { "S", "03/19/2022", "12:42 PM", "3:44 PM", "8", "14" };
		CGShift tcg_sat1 = new CGShift(sat1);
		String[] sat2 = new String[] { "S", "03/19/2022", "5:15 PM", "8:35 PM", "5", "14" };
		CGShift tcg_sat2 = new CGShift(sat2);
		String[] mon1 = new String[] { "M", "03/21/2022", "07:58 AM", "10:03 AM", "3", "14" };
		MarketShift tm_mon1 = new MarketShift(mon1);
		String[] wed1 = new String[] { "W", "03/23/2022", "07:51 AM", "10:02 AM", "3", "14" };
		MarketShift tm_wed1 = new MarketShift(wed1);
		String[] thurs1 = new String[] { "R", "03/24/2022", "1:01 PM", "4:11 PM", "3", "14" };
		MarketShift tm_thurs1 = new MarketShift(thurs1);
		String[] thurs2 = new String[] { "R", "03/24/2022", "4:58 PM", "7:04 PM", "2", "14" };
		CGShift tcg_thurs2 = new CGShift(thurs2);
		String[] fri2 = new String[] { "F", "03/25/2022", "7:54 AM", "10:03 AM", "3", "14" };
		MarketShift tm_fri2 = new MarketShift(fri2);
		String[] sat3 = new String[] { "S", "03/26/2022", "12:44 PM", "4:05 PM", "8", "14" };
		CGShift tcg_sat3 = new CGShift(sat3);
		String[] sat4 = new String[] { "S", "03/26/2022", "5:12 PM", "8:30 PM", "5", "14" };
		CGShift tcg_sat4 = new CGShift(sat4);
		String[] mon2 = new String[] { "M", "03/28/2022", "8:17 AM", "10:05 AM", "3", "14" };
